...
export type ComponentTypes =
    typeof Manbo.Constants.ComponentTypes.BUTTON
    | typeof Manbo.Constants.ComponentTypes.SELECT_MENU

export type InteractionTypes = typeof Manbo.Constants.InteractionTypes.MESSAGE_COMPONENT
...
export class InteractionCollector<K extends InteractionTypes = InteractionTypes, T extends keyof MappedInteractionTypesToComponentTypes[K] = keyof MappedInteractionTypesToComponentTypes[K]> extends Collector<MappedInteractionTypesToComponentTypes[K][T], InteractionCollectorEndReasons> {
    private channel: Manbo.TextChannel | Manbo.Uncached | null = null
     ...
     */
    public constructor(private client: Manbo.Client, public options: InteractionCollectorOptionsWithGenerics<K, T> = {}) {
        super(options)
    ...
    private handleThreadDeletion(thread: Manbo.ThreadChannel | Manbo.Uncached): void {
 ...
 */
export function awaitComponentInteractions<T extends ComponentTypes = ComponentTypes>(client: Manbo.Client, options: InteractionCollectorOptionsWithGenerics<typeof Manbo.Constants.InteractionTypes.MESSAGE_COMPONENT, T> = {}): Promise<MappedComponentTypes[T] | null> {
    const newOptions = {
        ...options,
        interactionType: Manbo.Constants.InteractionTypes.MESSAGE_COMPONENT,
        max: 1
    } as InteractionCollectorOptionsWithGenerics<typeof Manbo.Constants.InteractionTypes.MESSAGE_COMPONENT, T>
